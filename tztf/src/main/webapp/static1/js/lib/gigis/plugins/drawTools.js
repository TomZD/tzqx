    ...
    return function(id, imgUrl, zIndex, displayTools, callback) {
        ...
        if (displayTools && displayTools.length > 0) {
            for (var i = displayTools.length - 1; i >= 0; i--) {
                ...
                if (item.indexOf('drag') > -1) {
                    str += "<li data-val='drag' class='Gitool_li'><em class='gl_btn06'></em><p class='gl_sp'>拖曳</p></li>";
                }
                if (item.indexOf('cancel') > -1) {
                    str += "<li data-val='cancel' class='Gitool_li'><em class='gl_btn07'></em><p class='gl_sp'>清除</p></li>";
                }
                if (item.indexOf('screenshots') > -1) {
                    str += "<li data-val='screenshots' class='Gitool_li'><a class='screen-btn' id='btnCapture' href='javascript:StartCapture();'><em class='gl_btn08'></em><p class='gl_sp'>截屏</a></p></li>";
                }
                if (item.indexOf('origin') > -1) {
                    str += "<li data-val='origin' class='Gitool_li origin'><em class='gl_btn09'></em><p class='gl_sp'>回到原点</p></li></ul>";
                }
            };
        } else {
            str += "<li data-val='point' class='Gitool_li'><em class='gl_btn01'></em><p class='gl_sp'>点</p></li>";
        ...
        $(".screen-btn").on("click",function(){
            $(".screen-shot").removeClass("current");
            $(".screen-close").removeClass("current");
        });
        $(".screen-close").on("click",function(){
            $(".screen-shot").addClass("current");
        });
        /*屏幕截屏截止*/
