...
import cn.movinginfo.tztf.releasechannel.weibo4j.http.AccessToken;
import cn.movinginfo.tztf.releasechannel.weibo4j.http.BASE64Encoder;
import cn.movinginfo.tztf.releasechannel.weibo4j.http.Response;
...
public class Oauth extends Weibo {
	...
	public static void main(String[] args) {
		...
		try {
			String codeUrl = oauth.authorize("code");
			AccessToken accessToken = oauth.getAccessTokenByCode("");//oauth.authorize("code");
