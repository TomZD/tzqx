...
//        g.fillArc(110, 220, 100, 100, 70, 220);
        ...
        // 画多边形
        int px[] = { 210, 220, 270, 250, 240, 310, 320, 370, 350, 340};
        int py[] = { 220, 250, 300, 270, 220,320, 350, 400, 370, 320 };
        g.drawPolygon(px, py, px.length);
        // 填充多边形
        int px1[] = { 310, 320, 370, 400, 340 ,410, 420, 470, 500, 440};
        int py1[] = { 220, 250, 300, 270, 220 ,220, 250, 300, 270, 220};
