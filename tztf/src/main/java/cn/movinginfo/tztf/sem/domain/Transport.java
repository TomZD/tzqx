...
public class Transport implements Serializable {
    ...
    private String linkmanCommunicationType;	//通讯方式
    ...
    public String getLinkmanCommunicationType() {
        return linkmanCommunicationType;
    }

    public void setLinkmanCommunicationType(String linkmanCommunicationType) {
        this.linkmanCommunicationType = linkmanCommunicationType == null ? null : linkmanCommunicationType.trim();
    }
}