...
/**
 * <p>getNameByUserIdsResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getNameByUserIdsResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getnameByUserIdsResponse", propOrder = {
    "_return"
})
public class GetNameByUserIdsResponse {
