...
/**
 * <p>getUnReadListResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getUnReadListResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getunReadListResponse", propOrder = {
    "_return"
})
public class GetUnReadListResponse {
