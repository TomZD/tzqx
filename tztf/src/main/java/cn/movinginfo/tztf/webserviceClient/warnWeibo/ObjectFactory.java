 ...
 * generated in the cn.movinginfo.tztf.webserviceClient.warnWeibo package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sendword_QNAME = new QName("http://cxf.WarnWeibo.cn/", "sendword");
    private final static QName _Picsend_QNAME = new QName("http://cxf.WarnWeibo.cn/", "picsend");
    private final static QName _SendwordResponse_QNAME = new QName("http://cxf.WarnWeibo.cn/", "sendwordResponse");
    private final static QName _PicsendResponse_QNAME = new QName("http://cxf.WarnWeibo.cn/", "picsendResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.movinginfo.tztf.webserviceClient.warnWeibo
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.WarnWeibo.cn/", name = "sendword")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.WarnWeibo.cn/", name = "picsend")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.WarnWeibo.cn/", name = "sendwordResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://cxf.WarnWeibo.cn/", name = "picsendResponse")
