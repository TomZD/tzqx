package cn.movinginfo.tztf.releasechannel.weibo4j;

import java.util.List;
import java.util.Map;

import cn.movinginfo.tztf.releasechannel.weibo4j.http.ImageItem;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.Emotion;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.FriendsTimelineIds;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.MentionsIds;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.Paging;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.PostParameter;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.RepostTimelineIds;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.Status;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.StatusWapper;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.UserTimelineIds;
import cn.movinginfo.tztf.releasechannel.weibo4j.model.WeiboException;
import cn.movinginfo.tztf.releasechannel.weibo4j.org.json.JSONArray;
import cn.movinginfo.tztf.releasechannel.weibo4j.org.json.JSONObject;
import cn.movinginfo.tztf.releasechannel.weibo4j.util.ArrayUtils;
...
public class Timeline extends Weibo {
	 ...
	 * @since JDK 1.5
	 */
	public Status updateStatusWithPic(String status,ImageItem item) throws WeiboException {
	 ...
	 * @since JDK 1.5
	 */
	public Status updateStatusWithPic(String status,ImageItem[] items) throws WeiboException {
		return new Status(client.multPartURL(WeiboConfig.getValue("baseURL")
				+ "statuses/share.json",
				new PostParameter[] { new PostParameter("status", status) },items,
				access_token));
	}
