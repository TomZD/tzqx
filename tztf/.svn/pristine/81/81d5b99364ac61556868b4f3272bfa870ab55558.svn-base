...
/**
 * <p>getReadListResponse complex type�� Java �ࡣ
 * 
 * <p>����ģʽƬ��ָ�������ڴ����е�Ԥ�����ݡ�
 * 
 * <pre>
 * &lt;complexType name="getReadListResponse">
 *   &lt;complexContent>
...
@XmlType(name = "getreadListResponse", propOrder = {
    "_return"
})
public class GetReadListResponse {
