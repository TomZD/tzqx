...
//		$(".g-bd-right .h100").height(_h -$(".m-event").height() - 24);
    ...
    $(".report").on("click",function(e){
        ...
        $(".m-poplayer").find("div.popup_con").css("left", leftWidth).css("height", "400px").width(510).html(_body);
        /*添加popup_bd内容部分*/
        var _cent = '<div class="m-poplayer-table"><table><thead><tr><td colspan="2" style="text-align: center">变更申请</td></tr></thead>';
        var map = {};
...
//	             form.action = "/sev/alarm/detailsUpdate";
//	             form.submit();
	       	 
	       	$.ajax({
                cache: true,
                type: "post",
                url:"/sev/alarm/detailsUpdate",
