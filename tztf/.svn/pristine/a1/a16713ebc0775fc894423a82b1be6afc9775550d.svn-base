 ...
 * 
 */
@WebServiceClient(name = "WebService", targetNamespace = "http://tempuri.org/", wsdlLocation = "http://192.168.2.242:1234/WebService.asmx?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
        	String value = ConfigWebserviceHelper.getValue("GetM4Xml");
            url = new URL(value);
