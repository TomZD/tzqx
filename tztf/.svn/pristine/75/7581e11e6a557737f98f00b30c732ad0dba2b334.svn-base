...
for(var i in sites){
	if(sites[i].ty=="1"){
	        ...
	        offsetX : -10,
	        offsetY : -26,
	        content : sites[i].siteCode};
			indexI+=1;
	}
	if(sites[i].ty=="2"){
		console.log(sites[i].img);
		console.log(sites[i].lot);
		console.log(sites[i].lat);
		
		pointValues[i]={
				icon:{
					url : "/images/warnsmall/"+sites[i].img,
			        width : 40,
			        height : 40
		        },
		        lon : sites[i].lot,
