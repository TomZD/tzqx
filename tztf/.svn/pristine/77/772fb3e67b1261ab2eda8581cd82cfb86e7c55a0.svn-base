...
define(function(require) {
	...
	return OpenLayers.Class({
		...
		//------------弹层
		addPopup: function(lon, lat, contentHtml, offsetX, offsetY, close, closeBoxCallback,nokeepInMap) {
			var map = this.map;
			var popup = new Popup(
				"",
			...
			popup.keepInMap=!nokeepInMap;
			popup.panMapIfOutOfView=!nokeepInMap;
